...
namespace Pinterest.App.XamarinAndroid
{
	...
	public class DemoFromGallery : Activity
	{
		...
		private PinterestSDK.PinIt.PinItButton mPinIt;
		...
		protected override void OnCreate(Bundle savedInstanceState) 
		{
			...
			mPinIt = FindViewById<PinterestSDK.PinIt.PinItButton>(Resource.Id.pin_bt);
			mPinIt.Url = WEB_URL;
			mPinIt.Description = DEFAULT_DESCRIPTION;
			PinterestSDK.PinIt.PinItButton.DebugMode = true;
			PinterestSDK.PinIt.PinItButton.PartnerId = "myApp";
			PinterestSDK.PinIt.PinItButton.PartnerId = DemoMainActivity.CLIENT_ID;
